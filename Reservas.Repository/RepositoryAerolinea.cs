...
{
    public interface IRepositoryAerolinea<T> : ICrud<T>
    {
    }
    public class RepositoryAerolinea<T> : IRepositoryAerolinea<T> where T : IAerolinea
    {

        IDbContext<T> _ctx;

        public RepositoryAerolinea(IDbContext<T> ctx)
        {
            _ctx = ctx;
        }
