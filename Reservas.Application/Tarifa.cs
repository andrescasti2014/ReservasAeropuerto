...
{
    public interface IApplicationTarifa<T> : ICrud<T>
    {
    }
    public class Tarifa<T> : IApplicationTarifa<T> where T : ITarifa
    {
        IRepositoryTarifa<T> _repository;
        public Tarifa(IRepositoryTarifa<T> repository)
        {
