...
{
    public interface IApplicationAeropuerto<T> : ICrud<T>
    {
    }
    public class Aeropuerto<T> : IApplicationAeropuerto<T> where T : IAeropuerto
    {
        IRepositoryAeropuerto<T> _repository;
        public Aeropuerto(IRepositoryAeropuerto<T> repository)
        {
