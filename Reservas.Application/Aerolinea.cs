...
{
    public interface IApplicationAerolinea<T> : ICrud<T>
    {
    }

    public class Aerolinea<T> : IApplicationAerolinea<T> where T : IAerolinea
    {
        IRepositoryAerolinea<T> _repository;
        public Aerolinea(IRepositoryAerolinea<T> repository)
        {
